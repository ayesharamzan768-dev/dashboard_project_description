...
## 📋 Project Overview
This project is an interactive, professional-grade Data Visualization Dashboard built using **Streamlit**, **Pandas**, **Matplotlib**, and **Seaborn**. It analyzes the structural trends, mortality rates, and vector control interventions for Malaria cases across Pakistan from 2015 to 2025 using data structured under WHO Health Observatory criteria.
...
* `data/malaria_data.csv`: Source dataset containing 9 critical epidemiological features.
...
1. **Navigate into the Project Workspace:**
   Open your terminal/command prompt and shift focus to the extracted directory root folder:
   ```bash
