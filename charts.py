...
def generate_all_charts(df, point_option):
    """
    Core plotting engine. Renders the requested interactive chart based on the Side Panel point selection.
    """
    if df.empty:
        st.warning("No data available for the selected filters.")
        return

    # Clear category constraints safely
    ...
    # --- 9. COUNT & VIOLIN PLOTS ---
        ...
        # Split layout into columns for Count and Violin
        c1, c2 = st.columns(2)
        with c1:
