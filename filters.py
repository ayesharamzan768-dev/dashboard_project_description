...
def generate_125_countries_dataset(filepath):
    ...
    # 20 Western Pacific Region Countries
    wpr = ("Cambodia", "China", "Fiji", "Kiribati", "Lao PDR", "Malaysia", "Marshall Islands", "Micronesia", "New Zealand", "Palau", "Papua New Guinea", "Philippines", "Republic of Korea", "Samoa", "Solomon Islands", "Tonga", "Tuvalu", "Vanuatu", "Vietnam", "Australia")
...
def load_and_clean_data(filepath):
    ...
    if not os.path.exists(filepath):
        generate_125_countries_dataset(filepath)
...
def apply_dashboard_filters(df, selected_regions, selected_countries, year_range):
    ...
    # 1. Filter by selected WHO Regions
    if selected_regions:
    ...
    # 3. Filter by Year range using tuple unpacking
